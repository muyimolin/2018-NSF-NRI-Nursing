...
% and tempo-spatially coordinated motion primitives
 
% (a) Low-level parameterized controller (goal point can be a parameters)
% (b) grammatical inverse problem - composition (language generalization)
% (c) Efficient learning and generalization
% (d) Inter-dependency of motion primitives



% Motivation (Jane: please add one example to illustrate the contingency and variety of tasks in teleoperate system. The goal is to motivate the need to construct com-posable modules and building the task sequences from a language perspective)
...
% \textbf{Motion Theory} --- the principles and laws that reveal the regularity and variability of human motions;
...
%-------------------------------------------------------------------------
\subsubsection{Activity 2.2 --- Real-time Motion Prediction and Action Recognization}\label{sec:plan-intent-prediction}
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
\subsubsection{Activity 2.3 --- Inverse Reinforcement Learning for Reward in coordination of navigation and manipulation}\label{sec:plan-intent-SharedAutonomousCoordiantion}
%-------------------------------------------------------------------------
...
This project will be carried out by the PIs and three Ph.D. students.  The experimental validation will involve
undergraduate students through summer interns or senior design
projects. The anticipated schedule for the major tasks is shown in
Fig.~\ref{fig:timeline}.\vspace{-2ex}
\begin{wrapfigure}{r}{0.45\textwidth}
\begin{center}
\noindent\resizebox{0.45\textwidth}{!}{
\begin{tikzpicture}[x=.5cm, y=0cm]
\begin{ganttchart}[y unit title=0.3cm,
y unit chart=0.4cm, vgrid, title/.style={fill=black!60, draw=none},
...
\ganttbar[name=data]{Data collection and segmentation}{1}{8}\\
\ganttbar[name=dmpLearn]{Learning DMP}{1}{4}\\
\ganttbar[name=taskLearn]{Learning task constraints and dependency}{3}{6}\\
\ganttbar[name=adaptation]{Refinement and adaptation}{4}{6}
\ganttmilestone{Milestone: Task 1}{6} \\
\ganttgroup{Task 2}{1}{8}\\
\ganttbar[name=irlGame]{Inference of shared intent}{1}{3}\\
\ganttbar[name=intentDetect]{Goal-directed intent detection}{3}{6}\\
\ganttbar[name=motionPredict]{Motion prediction and action recognition}{6}{8}
\ganttmilestone{Milestone: Task 2}{8} \\
\ganttgroup{Task 3}{4}{12}\\
\ganttbar[name=experiment]{Evaluation}{4}{12}\\
\ganttbar[name=nav]{Developing navigation assistance}{6}{8}\\
\ganttbar[name=manipulation]{Developing  manipulation assistance}{6}{10}\\
\ganttbar[name=userStudy]{User study}{1}{12}
...
% \bibitem{Hauser_Li_Trina:17} Li, Zhi, Peter Moran, Qingyuan Dong, Ryan J. Shaw, and Kris Hauser. "Development of a Tele-Nursing Mobile Manipulator for Remote Care-giving in Quarantine Areas." In IEEE Int. Conf. Robotics and Automation. 2017.

% \bibitem{Hauser_Li_Bidirectional:17} Li, Jianqiao, Zhi Li, and Kris Hauser. "A Study of Bidirectionally Telepresent Tele-action During Robot-Mediated Handover." In IEEE Int. Conf. Robotics and Automation. 2017.
% \end{thebibliography}
